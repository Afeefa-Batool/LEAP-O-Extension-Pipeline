...
1. Upload `LEAP_O_Extension_Pipeline.ipynb` to [Google Colab](https://colab.research.google.com/).
2. **Runtime → Run all**.
3. Review RMSE table and planning visualization in the final cells.

---

*Workflow diagram: `LEAP_O_Workflow.png`*
